...
async def _main():
    ...
    scan_parser.add_argument("--config", default="config/exclusions.yaml", 
    ...
    delete_parser.add_argument("--config", default="config/exclusions.yaml", 
                              help="Path to exclusions configuration file")
    ...
    try:
        ...
        print(f"{Fore.RED}Error: Could not import Azure Nuke modules{Style.RESET_ALL}")
